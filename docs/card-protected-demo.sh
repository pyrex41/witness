...
echo ""
echo "High-level contracts are active. Gate 4 is live."
echo ""

echo "${CYAN}▶ STEP 1 — Targeted Gate 4 (emitter fidelity check)${NC}"
...
echo "    - Gate 4 verified the shen-witness emitter against the high-level"
echo "      verified-card contracts."
