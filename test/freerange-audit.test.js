...
// A minimal well-formed audit report for one numeric function.
function auditText({ domain = 'finite', coverage = '1/1 functions fully analyzed', extra = '' }) {
  return [
    `# ${FILE} (${coverage})`,
    '',
    '## Contracts',
    ...
    `  ensures: return is a ${domain} number from 100 through 200`,
    extra,
    '',
