 ...
 *
 * Usage: node .../card-emitter.js [--emit]
...
async function bootAndLoadCardSpec() {
  ...
  // card-spec.shen installs the real figma verify + loads tokens for the full path.
...
// CLI entry: node codegen/emitters/card-emitter.js [--emit]
...
//
// Gate 3 invokes this (with --emit for regeneration).
